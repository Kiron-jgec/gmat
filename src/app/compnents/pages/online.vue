...
We connect with our students either through Skype, Google Chat, or Zoom, where screen-sharing options are available. We connect an Ipad to our computer, enabling us to write out equations and solve problems in front of you. As far as homework and session problems, we provide students with access to our GMAT questions and answers database. Better still, we allow our students to record all of our sessions so that they can review anytime.
      ...
      <div class="imgSec">
        <img src="../../../assets/web Img/avatar-2.webp" alt="" />
      </div>
    </div>
...
<section>
       ...
       <div class="whyBeating">
           <div class="imgSec" >
        <img style="float:left" src="../../../assets/web Img/Bob-Chaparala.webp"  alt="" />
      </div>
      <div class="testSec">
        <h2>Online GMAT Test Prep – For Students of All Levels</h2>
        <p>
...
<section>
       ...
       <div class="whyBeating" style="background: rgb(229, 252, 229);">
         
      <div class="testSec">
        <h2>Over 20,000 GMAT Practice Questions</h2>
        <p>
        ...
        <div class="imgSec" >
        <img  src="../../../assets/web Img/online1.webp"  alt="" />
      </div>
    ...
    <div class="call">
  <h2>Have further GMAT preparation questions?</h2>
   <p> FOR FURTHER INFORMATION GIVE US A CALL AT - <strong> 212.393.4647</strong> </p>
      </div>
...
.whyGmatPrep p,.studentJarny p 
{
  padding: 0px 3%;

}
.studentJarny,.testSec
{
  text-align: center;
}
