<template>
  <div class="inperson">
    <h1>Expert One-On-One Tutoring With GMAT Tutor NYC</h1>


    <div class="whyBeating">
      <div class="testSec">
        <h2>Why Beating MBA Acceptance Rates Matters</h2>
        <p>
          According to a 2019 study known as
          <strong> The Business School Hiring Report,</strong> the median annual
          starting salary offered to new MBA hires was $115,000, comparatively
          the median for new bachelor’s degree hires was $55,000. If you are
          considering pursuing your MBA, the GMAT plays an important role in
          determining your candidacy. Moreover, it is one of the few areas of
          your application, where you can still make significant changes. The
          average score for the top 25 MBA programs is 713. Meanwhile, the
          average time spent studying by the average GMAT 700 scorer is 120
          hours.
        </p>
      </div>
      <div class="imgSec">
...
<section>
    <div class="whyBeating">
      <div class="testSec2">
        <h2>GMAT Tutor NYC’s Proprietary Techniques</h2>
        <p>
      ...
      <div class="imgSec3">
        <p>Our GMAT techniques were developed by taking concepts from engineering, math, and finance, and applying them to the GMAT. The reason these techniques work is that they perform the same function as the traditionally taught approaches, just faster. Math is a flexible subject, there may only be one right answer, but there are multiple ways to reach it. We have scoured academia to find the easiest routes to specific GMAT archetypes. And to be very clear, these are not answer picking short cuts or pattern recognition tactics. Instead, these are real techniques applied by various academic disciplines. We place so much emphasis upon these techniques because past the 700 level, saving time becomes even more critical as each problem requires more solving. Not only have we developed and tested these techniques, but they have been used with great success by thousands of our students.</p>
      </div>
    </div>
...
<section>
    <div class="theDatabase">
        <h2>The Database: 20,000+ Questions</h2>
        <p>
...
.whyGmatPrep,.Acceptance,.inpVson
{
    padding: 20px 4%;
    text-align: center;
}
